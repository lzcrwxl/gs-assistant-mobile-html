<template>
  <div id="createOrder">
    <HeadView v-if="headerShow"></HeadView>
    <div class="modify-order-content">
      ...
      <OrderTemplate :btn-msg="msg" ref="order" :createBtn.sync="createBtn" :isAunt.sync="isAunt">
       <!-- <div class="mt20 mb20 tc">
          <button class="btn-block btn-fill" @click="confirmCreate">确认创建</button>
        </div>-->
      </OrderTemplate>
...
//      确认创建
      confirmCreate(){
        this.$refs.order.$emit('bridge','你好吗!');
        let _this = this;
      },
    },
    watch:{

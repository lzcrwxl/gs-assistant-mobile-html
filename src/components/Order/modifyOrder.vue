<template>
  <div id="modifyOrder">
    ...
    <div class="modify-order-content">
      ...
      <modifyOrderTemplate :order="order" :member="member" :service="service" :staff="staff" :btnMsg="btnMsg">
        <!--<div class="mt20 mb20 tc">
          <button class="btn-block btn-fill">确认保存</button>
        </div>-->
      </modifyOrderTemplate>
    </div>
  </div>

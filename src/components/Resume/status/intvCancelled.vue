  ...
  <div id="intvCancelled">
    ...
    <div class="resumeCtn">
      ...
      <!--<div class="auntFooter">
        <router-link to="/order/1" class="btn-smer btn-grey">原始订单</router-link>
        <a :href="tel" class="btn-smer btn-fill mobileBtn"><span>{{sourceInfo.contactName}}</span></a>
      </div>-->
